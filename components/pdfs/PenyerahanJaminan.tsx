"use client";
import { IPenyerahanJaminan } from "../IInterfaces";
...
const generateTBO = (data: IPenyerahanJaminan) => {
  const html = `
  <!doctype html>
  <html>
    <head>
    ...
    <body class="bg-white text-gray-800 leading-relaxed p-8 max-w-[800px]">
      <div class="page" style="font-size: 13px;">
        ${HeaderTwoLogoCustom(data, "TANDA TERIMA PENYERAHAN JAMINAN")}
        ...
        <div class="my-5">
          ...
          <div class="flex gap-2">
            ...
            <p class="w-4">:</p>
            <p>Penyerahan Jaminan Kredit Debitur</p>
          </div>
        </div>
      ...
      <div class="my-10">
        ...
        } informasikan penyerahan jaminan kredit debitur yang telah mendapat dana Dropping dari ${
    data.Sumdan.name
  }. Adapun rincian data penyerahan jaminan tersebut kami lampirkan bersama dengan surat ini pada halaman 2 (lampiran).</p>
        <div class="my-5"></div>
        <p>Kami berharap jaminan tersebut dapat diproses sesuai prosedur dan ketentuan yang berlaku. Apabila diperlukan informasi tambahan, kami siap memberikan keterangan lebih lanjut.</p>
        <p>Demikian surat Penyerahan Jaminan ini kami sampaikan. Atas perhatian dan kerjasamanya, kami ucapkan terima kasih.</p>
      ...
      <div class="page">
        ...
        ${HeaderTwoLogoCustom(data, "LAMPIRAN PENYERAHAN JAMINAN")}

          <div class="my-10">
            <p>Lampiran Penyerahan Jaminan Nomor ${data.id}</p>
          </div>
          <div class="my-5">
...
export const printTBO = (record: IPenyerahanJaminan) => {
  const htmlContent = generateTBO(record);
